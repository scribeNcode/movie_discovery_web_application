  ...
  return (
    <div className="NavbarWrapper">
      ...
      <div className="search_div">
        <input type="search" name="" id="searchIcon" placeholder="What do you want to watch?"/>
        
        <div className="search_icon_wrapper"> <label htmlFor="searchIcon"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
